...
export default function Year2019Page({ event }) {
    const title = event?.title || "श्री रामलीला महोत्सव 2019";
    const description = event?.description || "वर्ष 2019 में श्री रामलीला सेवा ट्रस्ट ने गौर सिटी, ग्रेटर नोएडा वेस्ट में एक भव्य और यादगार रामलीला का आयोजन किया। इस वर्ष के आयोजन में विशाल मंच, भव्य सज्जा और उत्कृष्ट कलाकारों के प्रदर्शन ने दर्शकों को मंत्रमुग्ध कर दिया।";
        ...
        <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 bg-white rounded-3xl p-4 md:p-6 shadow-xl border border-amber-900/10">
                ...
                <div className="relative w-full h-full min-h-[300px] rounded-2xl overflow-hidden shadow-md lg:col-span-5">
                    <Image
                        src={images[0] || "/images/achievements/yoga/3.jpg"}
                        alt={title}
                        fill
                ...
                <div className="flex flex-col h-full p-4 lg:p-8 lg:col-span-7">
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-auto">
                        ...
                        <div className="text-center p-3 rounded-xl bg-amber-50/80 border border-amber-900/10">
                            <div className="text-2xl font-bold text-[#98221b]">2019</div>
            ...
            <div>
                <h2 className="text-2xl md:text-3xl font-bold text-[#4d1700] mb-6" style={{ fontFamily: "var(--font-cinzel), serif" }}>
                    2019 Event Highlights & Glimpses
                </h2>
                <EventGalleryTabs year="2019" />
            </div>
        </div>
    );
}
