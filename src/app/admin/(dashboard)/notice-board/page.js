...
import { getNotice, createNotice, updateNotice, deleteNotice } from "@/app/actions/notice-board";
        ...
        <div>
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-[#F5E9D2]/50 text-sm mt-1">Manage Notice Board</p>
                </div>
            ...
            <div className="admin-card overflow-hidden">
                {loading ? (
                    ...
                    <p className="text-[#F5E9D2]/40 text-sm py-12 text-center">No notice yet.</p>
                ) : (
                    ...
                    <div className="admin-modal" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-lg font-bold text-[#F5E9D2]">
                                {editingItem ? "Edit Notice" : "Add Notice"}
                            </h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="description" defaultValue={editingItem?.description} className="admin-input admin-textarea" rows={6} />
                            </div>
                            <div>
